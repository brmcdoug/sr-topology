...
func (a *arangoDB) processEdge(ctx context.Context, key string, e *message.LSLink) error {
	...
	ne := lslinkEdgeObject{
		...
		UnidirLinkDelay:       e.UnidirLinkDelay,
		UnidirLinkDelayMinMax: e.UnidirLinkDelayMinMax,
		UnidirDelayVariation:  e.UnidirDelayVariation,
		UnidirPacketLoss:      e.UnidirPacketLoss,
		UnidirResidualBW:      e.UnidirResidualBW,
		UnidirAvailableBW:     e.UnidirAvailableBW,
		UnidirBWUtilization:   e.UnidirBWUtilization,
	}
